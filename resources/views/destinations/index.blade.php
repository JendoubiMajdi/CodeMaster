                ...
                <div class="col-md-4 mb-4">
                    <div class="card" style="border-radius: 10px; box-shadow: 0 4px 10px rgba(0, 0, 0, 0.1);">
                        <div class="card-body">
                            ...
                            <p class="card-text"><strong>Description :</strong> {{ $destination->description }}</p>

                            @if ($destination->image)
                                <img src="{{ asset('storage/' . $destination->image) }}" alt="{{ $destination->nom }}" class="img-fluid" style="border-radius: 10px; max-height: 200px; object-fit: cover; width: 100%;">
                            @endif
